...
Convert::Digits - Convert Digits Between the Scripts of Unicode.


=head1 SYNOPSIS

 use utf8;
 require Convert::Digits;

 my $number = 12345;
 my $d = new Convert::Digits ( $number );
...
The C<Convert::Digits> will convert a sequence of digits from one
...
Ethiopic and Tamil scripts do not have a zero.  Western 0 is used instead.
...
(and your starting number is an applicable sequence).  The C<Convert::Digits>
